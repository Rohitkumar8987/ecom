    ...
    return (
      <>
        ...
        {filter.map((product) => {
          return (
            <>
              <div className="col-md-3 mb-4 p-5 " style={{display:"inline-table"}}>
                <div className="card h-100 text-center p-4" key={product.id}>
                    <img src="" alt={product.title} height="250px" />
    ...
    <div classNameName="container my-5 py-5">
      <div classNameName="row">
        <div classNameName="col-12 mb-5 ">
          <h1 classNameName="display-6 fw-bolder  mt-3 text-center" style={{display:"flex",justifyContent:"center",}}>
            Latest Products
          </h1>
          <hr />
        </div>
